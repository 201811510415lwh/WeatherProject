            ...
            <ul class="nav navbar-nav">
                ...
                <li role="presentation" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="active"><a href="function/weatherServlet?action=chartsForRainyDays" class="list-group-item ">查看每年降雨天数变化</a></li>
                    </ul>
                </li>
            </ul>
        </div>
